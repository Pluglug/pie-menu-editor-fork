...
- **Support the original developer** → Purchase PME on [Blender Market](https://superhivemarket.com/products/pie-menu-editor?ref=7373) or [Gumroad](https://roaoao.gumroad.com/l/pie_menu_editor)
- **Support maintenance work** → Support via [ko-fi](https://ko-fi.com/Pluglug)
...
* **Bug Reports** → via the [Issues](../../issues) page
...
* **Community Discussion** → Join the active community on [BlenderArtists Forum](http://blenderartists.org/forum/showthread.php?392910). You can also use the [Discussions](../../discussions) section for additional topics.
...
For issues, feature regressions, or crash reports, please use the [Issues](../../issues) page.
