# core/constants.py - Constants and enum definitions
# LAYER = "core"
#
# Moved from: constants.py (PME2 layer separation)
# Note: This module has minimal bpy dependency (BL_ICONS, AreaEnumHelper)
# Future work: Split into pure-Python constants and bpy-dependent parts
...
W_PMI_DESC_SYNTAX = "Invalid description expression"
